...
public class DEFAULT_PERIOD_TABLE {
    ...
    private static final String[] INITIALIZING_TABLE = {
            ...
            "insert into DEFAULT_PERIOD (bigCategory, detailCategory, period) values (유제품, 치즈, )",
            "insert into DEFAULT_PERIOD (bigCategory, detailCategory, period) values (유제품, 요거트, )",
            "insert into DEFAULT_PERIOD (bigCategory, detailCategory, period) values (유제품, 우유, )",
            "insert into DEFAULT_PERIOD (bigCategory, detailCategory, period) values (유제품, 버터, )",


            "insert into DEFAULT_PERIOD (bigCategory, detailCategory, period) values (난류, 계란, )",
            "insert into DEFAULT_PERIOD (bigCategory, detailCategory, period) values (난류, 메추리알, )",


            "insert into DEFAULT_PERIOD (bigCategory, detailCategory, period) values (콩류, 두부, )",
